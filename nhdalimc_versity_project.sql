...
--
-- Host: localhost:3306
-- Generation Time: Mar 26, 2021 at 06:12 AM
...
--
-- Database: `nhdalimc_versity_project`
--
...
(16, 'Web developer', 11, '2020-10-16 05:54:57', '2020-10-16 05:54:57'),
(17, 'laravel developer', 14, '2021-02-05 19:03:16', '2021-02-05 19:03:16');
...
(19, 16, 11, 'admin', NULL, NULL),
(20, 16, 5, 'user', NULL, NULL),
(21, 17, 14, 'admin', NULL, NULL),
(22, 16, 9, 'user', NULL, NULL);
...
(10, 'nazmul Hasan', 'nazmul_2734@diu.edu.bd', 'hi', 1, 16, 17, '2020-10-16 05:56:33', '2020-10-16 05:56:33');
...
(1, 3, 'Laravel Developer', 'LumexTech', 'Toronto', 'tanjina@yahoo.com', 'Full Time', '50000', NULL, '<p><span>@user3386779: It works but is not the most beautiful solution :) Laravel has few mechanisms to do this things. If you choose my answer you need set date format in one place and don\'t need remember to change the date format every time you need display from_date column.</span></p>', '1. Laravel\r\n2.  HTML\r\n3. Python\r\n4. MySQL', '<p><span>@user3386779: It works but is not the most beautiful solution :) Laravel has few mechanisms to do this things. If you choose my answer you need set date format in one place and don\'t need remember to change the date format every time you need display from_date column.</span></p>', '<p><span>@user3386779: It works but is not the most beautiful solution :) Laravel has few mechanisms to do this things. If you choose my answer you need set date format in one place and don\'t need remember to change the date format every time you need display from_date column.</span></p>', '<p><span>@user3386779: It works but is not the most beautiful solution :) Laravel has few mechanisms to do this things. If you choose my answer you need set date format in one place and don\'t need remember to change the date format every time you need display from_date column.</span></p>', '2021-05-22 07:59:36', '2021-05-22 07:59:36', 1, 'per year', '', '2021-05-10', NULL),
...
('dalim2734@gmail.com', '$2y$10$7T69p9JretHm4idqISXrJu3r6Oll2sYcaCVOEqHsv1Ha9qVFeElTq', '2020-07-21 18:37:22');
...
(1, 'web-development', 'whether the migration will be creating a new table', '<p>A migration class contains two methods: up and down. The up method is used to add new tables, columns, or indexes to your database, while the down method should simply reverse the operations performed by the up method.</p>\n<p> </p>\n<p>Within both of these methods you may use the Laravel schema builder to expressively create and modify tables. To learn about all of the methods available on the Schema builder, <a href=\"https://laravel.com/docs/5.4/migrations#creating-tables\">check out its documentation</a>. For example, this migration example creates a flights table:</p>\n<p> </p>\n<p>A migration class contains two methods: up and down. The up method is used to add new tables, columns, or indexes to your database, while the down method should simply reverse the operations performed by the up method.</p>\n<p> </p>\n<p>Within both of these methods you may use the Laravel schema builder to expressively create and modify tables. To learn about all of the methods available on the Schema builder, <a href=\"https://laravel.com/docs/5.4/migrations#creating-tables\">check out its documentation</a>. For example, this migration example creates a flights table:</p>\n<p> </p>', NULL, '2017-02-01 07:44:17', '2021-02-15 11:34:08', 'whether-the-migration-will-be-creating-a-new-table', 37, '3'),
(12, 'web-development', 'Remove-Item Powershell not working in Windows Temp folder', '<p style=\"text-align:left;\">I have a server with an incredibly overloaded Windows/Temp folder. So, I wanted to run a simple Powershell script to clear it out (I\'m talking tens of thousands of .tmp and .bak files that are over a year old). Below is the code: <br />Remove-Item C:\\Windows\\Temp\\* -include .txt,.bak,.tmp -whatif <br /> I tried removing the whatif as well (I just had that in there because I was playing around with some stuff) and nothing happens. It\'s so simple I\'m almost definitely missing something simple. <br /> Thanks in advance</p>', NULL, '2017-03-14 17:16:44', '2021-02-15 11:32:51', 'remove-item-powershell-not-working-in-windows-temp-folder', 21, '5'),
(18, 'desktop-application', 'After installing Laravel, you should configure your web server\'s document', '<p>After installing Laravel, you should configure your web server\'s document / web root to be the <span>public</span> directory. The index<span>.</span>php in this directory serves as the front controller for all HTTP requests entering your application.</p>\n<h4>Configuration Files</h4>\n<p>All of the configuration files for the Laravel framework are stored in the config directory. Each option is documented, so feel free to look through the files and get familiar with the options available to you.</p>\n<h4>Directory Permissions</h4>\n<p>After installing Laravel, you may need to configure some permissions. Directories within the storage and the bootstrap<span>/</span>cache directories should be writable by your web server or Laravel will not run. If you are using the <a href=\"https://laravel.com/docs/5.4/homestead\">Homestead</a> virtual machine, these permissions should already be set.</p>\n<h4>Application Key</h4>\n<p>The next thing you should do after installing Laravel is set your application key to a random string. If you installed Laravel via Composer or the Laravel installer, this key has already been set for you by the php artisan key<span>:</span>generate command.</p>\n<p>Typically, this string should be 32 characters long. The key can be set in the <span>.</span>env environment file. If you have not renamed the <span>.</span>env<span>.</span>example file to <span>.</span>env, you should do that now. <strong>If the application key is not set, your user sessions and other encrypted data will not be secure!</strong></p>', NULL, '2017-03-21 06:49:09', '2021-03-25 17:25:36', 'after-installing-laravel-you-should-configure-your-web-servers-document', 23, '4'),
(19, 'web-development', 'Laravel 5.4 Authentication not working', '<p style=\"font-family:Arial, \'Helvetica Neue\', Helvetica, sans-serif;font-size:15px;color:#242729;background-color:#ffffff;\">Im trying to create login form and its controller but when i try to login it doesnt work can any one help me i\'m very new in laravel. here is my form:</p>\n<p style=\"font-family:Arial, \'Helvetica Neue\', Helvetica, sans-serif;font-size:15px;color:#242729;background-color:#ffffff;\"><span style=\"background-color:transparent;font-family:inherit;font-style:inherit;font-weight:inherit;font-size:13px;\">&lt;form action=</span><span style=\"background-color:transparent;font-family:inherit;font-style:inherit;font-weight:inherit;font-size:13px;\">\"/login\"</span><span style=\"background-color:transparent;font-family:inherit;font-style:inherit;font-weight:inherit;font-size:13px;\"> method=</span><span style=\"background-color:transparent;font-family:inherit;font-style:inherit;font-weight:inherit;font-size:13px;\">\"post\"</span><span style=\"background-color:transparent;font-family:inherit;font-style:inherit;font-weight:inherit;font-size:13px;\">&gt;</span></p>\n        {{ csrf_field() }}\n\n        &lt;div <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\"><span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">class</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">form</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">group</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">has</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">feedback</span>\"&gt;\n            &lt;<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">input</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">type</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">email</span>\" <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">name</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">email</span>\" <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">class</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">form</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">control</span>\" <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">placeholder</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Email</span>\"&gt;\n            &lt;<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">span</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">class</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">glyphicon</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">glyphicon</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">envelope</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">form</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">control</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">feedback</span>\"&gt;&lt;/<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">span</span>&gt;\n        &lt;/<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">div</span>&gt;\n        &lt;<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">div</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">class</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">form</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">group</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">has</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">feedback</span>\"&gt;\n            &lt;<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">input</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">type</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">password</span>\" <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">name</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">password</span>\" <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">class</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">form</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">control</span>\" <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">placeholder</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Password</span>\"&gt;\n            &lt;<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">span</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">class</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">glyphicon</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">glyphicon</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">lock</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">form</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">control</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">feedback</span>\"&gt;&lt;/<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">span</span>&gt;\n        &lt;/<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">div</span>&gt;\n        &lt;<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">div</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">class</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">row</span>\"&gt;\n            &lt;<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">div</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">class</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">col</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">xs</span>-7\"&gt;\n                &lt;<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">div</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">class</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">checkbox</span>\"&gt;\n                    &lt;<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">label</span>&gt;\n                        &lt;<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">input</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">type</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">checkbox</span>\"&gt; <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Remember</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Me</span>\n                    &lt;/<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">label</span>&gt;\n                &lt;/<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">div</span>&gt;\n            &lt;/<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">div</span>&gt;\n            &lt;!-- /.<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">col</span> --&gt;\n            &lt;<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">div</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">class</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">col</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">xs</span>-5\"&gt;\n                &lt;<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">button</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">type</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">submit</span>\" <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">class</span>=\"<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">btn</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">btn</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">primary</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">btn</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">raised</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">btn</span>-<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">block</span> \"&gt;<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Sign</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">In</span>&lt;/<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">button</span>&gt;\n            &lt;/<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">div</span>&gt;\n            &lt;!-- /.<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">col</span> --&gt;\n        &lt;/<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">div</span>&gt;\n    &lt;/<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">form</span>&gt;</span>', NULL, '2021-02-05 18:18:38', '2021-02-15 11:33:54', 'laravel-54-authentication-not-working', 9, '13'),
(20, 'web-development', 'How to fix login page Laravel ui auth didn\'t display any error message when wrong input email/password', '<p><span style=\"color:#242729;font-family:Arial, \'Helvetica Neue\', Helvetica, sans-serif;font-size:15px;background-color:#ffffff;\">I have project build in Laravel 8 and have login page on it, but I have problem, the login page didnt show any error message when user input wrong password or email. here is my login controller</span></p>\n<p><span style=\"font-family:inherit;font-style:inherit;font-weight:inherit;font-size:13px;\">&lt;?php</span></p>\n\n<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">namespace</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">App</span>\\<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Http</span>\\<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Controllers</span>\\<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Auth</span>;\n\n<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">use</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">App</span>\\<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Http</span>\\<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Controllers</span>\\<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Controller</span>;\n<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">use</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">App</span>\\<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Providers</span>\\<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">RouteServiceProvider</span>;\n<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">use</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Illuminate</span>\\<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Foundation</span>\\<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Auth</span>\\<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">AuthenticatesUsers</span>;\n<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">use</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Illuminate</span>\\<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Http</span>\\<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Request</span>;\n\n<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\"><span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">class</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">LoginController</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">extends</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Controller</span>\n</span>{\n  \n\n    <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">use</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">AuthenticatesUsers</span>;\n\n\n    <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">protected</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">$redirectTo</span> = RouteServiceProvider::HOME;\n\n\n    <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">public</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\"><span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">function</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">__construct</span>()\n    </span>{\n        <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">$this</span>-&gt;middleware(<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'guest\'</span>)-&gt;except(<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'logout\'</span>);\n    }\n    <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">public</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\"><span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">function</span> <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">login</span>(<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">Request <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">$request</span></span>)\n    </span>{\n        <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">$input</span> = <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">$request</span>-&gt;all();\n\n        <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">$this</span>-&gt;validate(<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">$request</span>, [\n            <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'email\'</span> =&gt; <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'required|email\'</span>,\n            <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'password\'</span> =&gt; <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'required\'</span>,\n           \n        ]);\n\n        <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">if</span> (auth()-&gt;attempt(<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">array</span>(<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'email\'</span> =&gt; <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">$input</span>[<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'email\'</span>], <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'password\'</span> =&gt; <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">$input</span>[<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'password\'</span>]))) {\n            <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">if</span> (auth()-&gt;user()) {\n                <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">return</span> redirect()-&gt;route(<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'home.index\'</span>);\n            }\n        } <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">else</span> {\n            <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">return</span> redirect()-&gt;route(<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'login\'</span>)\n                -&gt;with(<span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'error\'</span>, <span style=\"font-style:inherit;font-weight:inherit;font-family:inherit;\">\'Email-Address And Password Are Wrong.\'</span>);\n        }\n    }\n}', NULL, '2021-02-05 18:28:22', '2021-02-15 23:23:50', 'how-to-fix-login-page-laravel-ui-auth-didnt-display-any-error-message-when-wrong-input-emailpassword', 6, '13'),
(21, 'web-development', 'Laravel is a web application framework with expressive', '<p style=\"color:#2b2e38;font-family:\'scandia-web\', \'ui-sans-serif\', \'system-ui\', \'-apple-system\', BlinkMacSystemFont, \'Segoe UI\', Roboto, \'Helvetica Neue\', Arial, \'Noto Sans\', sans-serif, \'Apple Color Emoji\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'Noto Color Emoji\';\">Laravel is a web application framework with expressive, elegant syntax. We believe development must be an enjoyable, creative experience to be truly fulfilling. Laravel attempts to take the pain out of development by easing common tasks used in the majority of web projects, such as authentication, routing, sessions, and caching.</p>\n<p style=\"color:#2b2e38;font-family:\'scandia-web\', \'ui-sans-serif\', \'system-ui\', \'-apple-system\', BlinkMacSystemFont, \'Segoe UI\', Roboto, \'Helvetica Neue\', Arial, \'Noto Sans\', sans-serif, \'Apple Color Emoji\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'Noto Color Emoji\';\">Laravel aims to make the development process a pleasing one for the developer without sacrificing application functionality. Happy developers make the best code. To this end, we\'ve attempted to combine the very best of what we have seen in other web frameworks, including frameworks implemented in other languages, such as Ruby on Rails, ASP.NET MVC, and Sinatra.</p>\n<p style=\"color:#2b2e38;font-family:\'scandia-web\', \'ui-sans-serif\', \'system-ui\', \'-apple-system\', BlinkMacSystemFont, \'Segoe UI\', Roboto, \'Helvetica Neue\', Arial, \'Noto Sans\', sans-serif, \'Apple Color Emoji\', \'Segoe UI Emoji\', \'Segoe UI Symbol\', \'Noto Color Emoji\';\"><span style=\"font-size:16px;\">Laravel is accessible, yet powerful, providing powerful tools needed for large, robust applications. A superb inversion of control container, expressive migration system.</span></p>', NULL, '2021-02-05 18:35:03', '2021-03-25 13:39:56', 'laravel-is-a-web-application-framework-with-expressive', 8, '4');
...
(49, 19, 'php-developer', 'web-development'),
(50, 20, 'laravel', 'web-development'),
(51, 20, 'javascript', 'web-development');
...
(18, 'Jquery', 'dalim', '2017-01-30 11:58:49', '2020-09-08 10:23:24');
...
(3, 'tanjina akter', 'tanjina@yahoo.com', '$2y$10$2t3y8Lo6BIXy7d0vOxuzPeEEkIXb043JAQMc4wh2Bzbdx.K.1GwSG', 'blz1s0yoMgrLH2fGR7d8bnHxKQt1PT2KAhspfRPZCFTf1QMsufEZGs1sa5iu', '2017-01-29 10:18:53', '2017-01-29 10:18:53'),
(4, 'dalim', 'dalim2734@gmail.com', '$2y$10$z3OiMFYisKbTkBfDjT16NuqiYWxHUH1Ww59txe9VPbcD8l5FHVUGO', '1rVUwWi8SLOoujOsvMY8HTcf3XNAqtQNsUizHW0ECKVtZjzMJzXAvH5p2T3c', '2017-01-29 10:20:08', '2017-01-29 10:20:08'),
...
(11, 'nazmul Hasan', 'nazmul_2734@diu.edu.bd', '$2y$10$6V4XxZb0fYbbYfeVxfk8Nur9atNDAIFOiqIvrozzqq1X8wlfhhGnK', 'v509PmbJ3O0H18FJXcnHmwWnZOZD7cOmV1gHhY7ImgytdpsVr0VVwnkNBBiY', '2020-07-21 18:44:55', '2020-07-21 18:44:55'),
(12, 'tamim', 'tamim@yahoo.com', '$2y$10$l/i1Q57CKeeRg8xQw/q1UOdJ/PEAY5L2XTLHlm/Gmtim64arLtSd2', 'RLcVhOxVjCX1DsCeZZvoAN15rWUdckAlLZ888rY6SmiR9Ma7dRqGgh6xWRz1', '2021-02-04 22:08:45', '2021-02-04 22:08:45'),
(13, 'shakib khan', 'shakib@gmail.com', '$2y$10$3x7gDW7rKzO/ibisNxuNmOAJe4biW80kKbytSltTMAViZP80GAUAO', 'WnsEvB9H6tOk02IAI254wsBvT39GG0MWBq9Bl26tsvYTtcOyOjHMcD4b8OCh', '2021-02-05 18:15:15', '2021-02-05 18:15:15'),
(14, 'tamim khan', 'tamim@gmail.com', '$2y$10$I7jBZkfehidnA.ZKFw2CRu7sWW8JBVBq/no0ls9fpu5njyLZ5wlDe', NULL, '2021-02-05 19:02:39', '2021-02-05 19:02:39');
