...
@section('maincontent')
 ...
 style="font-size: 23px;line-height: 1.35; font-weight: normal;">
                      	{{ $article->title }}
                      	<br>
                      </h1>
                    	</div>
               ...
               {{-- @if($article->image)
                ...
                @endif      --}}
                 <div class="col-md-11 col-md-offset-1" style="font-size: 16px; padding: 0px 30px !important; text-align:justify">
                      <br>
                    	{!! $article->body !!}
