...
<div class="col-md-9  text-left">
  <!-- Nav tabs -->
  <div class=" row">
    <div class="nav col-md-6 col-sm-6 col-xs-6">
      <div class="navbar-left">
        <ul style="margin-top:25px !important; margin-left:10px">
    ...
    <div class="nav col-md-6 col-md-6 col-sm-6 col-xs-6">
      <div class="navbar-right filters">
        <ul class="filter ">
          <li class="dropdown">
            <button href="#" class="button btn btn-lg dropdown-toggle" data-toggle="dropdown" role="button"
    ...
    <div class="col-md-9 col-sm-9 col-xs-9">
      <div class="question">
        ...
        <p>
          ...
          <span class="time"> {{ date('h:i A',strtotime($questions->created_at)) }}</span> by<span class="post-owner"><a
              href="#"> {{ App\User::find($questions->created_by)->name }} </a></span></p>
        <p class="tags">tags:
...
<div class="col-md-3 col-sm-12 col-xs-12 right-sidebar">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 filter categories">
      ...
      <div style="border:2px solid orange">
        ...
        <a href="{{ url('/tag_post',$tags->id) }}" style="text-decoration: none"> <span class="label label-warning">
            {{ $tags->name }}</span></a>
