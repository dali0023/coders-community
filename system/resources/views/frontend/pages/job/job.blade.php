...
<div class="col-md-9  text-left ">
  ...
  <div class="row featured-job">
    ...
    <div class="col-md-9 col-sm-9 col-xs-9 job-content">
      ...
      <div class=" job">
        <p><span>Company:</span> {{ $jobs->company_title }}</p>
  ...
  <div class="row featured-job">
    <div class="title text-center">
      <h3><a>{{ $jobs->company_name }}</a></h3>
    </div>
    <div class="col-md-9 col-sm-9 col-xs-9 job-content">

      <div class=" job">
        <p><span>Company:</span> {{ $jobs->name }}</p>
        <p><span>Location:</span> {{ 
                ...
                <div class="collapse" id="toggle" style="height: 0px;">
                  <ul class="nav nav-list">
                    ...
                    <li>
                      <div class="checkbox">
                        <label>
                          <input type="checkbox" name="job_function[]"
