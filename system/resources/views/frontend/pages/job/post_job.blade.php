...
font-size: 12px;" data-show-subtext="true" data-live-search="true" name="location_name">
      ...
      <div class="form-group">
        <label for="exampleInputPassword1">Applications for this job will be sent to the following email
          address(es):</label>
...
font-size: 12px;" class="form-control salary_value_empty" placeholder="e.g. 40, 000.00">
        ...
        <a id="add-range" class="add_field_button"><i class="fa fa-plus-circle" aria-hidden="true"></i>Add Salary
          Range</a>
      </div>
...
font-size: 12px;" class="form-control back_value_empty" placeholder="e.g. 70, 000.00">
        ...
        <a id="back-one-range" class="add_field_button"><i class="fa fa-plus-circle" aria-hidden="true"></i>Back One
          Range</a>
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" style="height: 31px;font-size: 12px; width: 31% !important"
          id="datepicker" name="dedline">
