        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown ">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="{{ url('/leave-group',$current_group->id) }}">Leave Group</a></li>
            </ul>
          </li>
  ...
  <div>
    ...
    <div class="comment">
      <div class="author-info">
        <img src="{{ "https://www.gravatar.com/avatar/".md5(strtolower(trim($group_post->email)))."?s=50&d=mm" }}"
          class="author-image">
      ...
      <div class="comment-content text-left" style="font-size: 15px">
        ...
        <a href="{{ url('post-details/'.$group_post->group_id.'/'.$group_post->id) }}"
          style="text-decoration: none;font-size: 16px; color:orange"> Learn More</a>
        @endif
        <br>

        <h4 style="margin-top: 6px">
          <span class="glyphicon glyphicon-comment" style="color: orange"></span><a
            href="{{ url('post-details/'.$group_post->group_id.'/'.$group_post->id) }}"
  ...
  <div class="" style="margin-top: 14px;">
    <div class="member">
      ...
      <div class="membersdes ">
        <span class="text-left">All Members</span>
        <span class="mem-num text-right">
          <span class="badge badge-success badge-pill">{{count($group2)}}</span>
        </span>
        <div class="col-md-12">
          @foreach ($group2 as $item)
          <div class="col-md-1" style="margin: 10px;">
            <figure class="img" style="border: 1px solid rgb(110, 110, 110)">
              <img src="{!! asset('frontend-style/images/users.png') !!}" class="img-responsive">
              <figcaption class="figure-caption">
                {{App\User::find($item->users_id)->name}}
              </figcaption>
            </figure>
          </div> &nbsp;
          @endforeach
