...
<link rel="stylesheet" type="text/css"
    href="https://jmblog.github.io/color-themes-for-google-code-prettify/themes/atelier-cave-light.min.css">

<div class="col-md-9  text-left">
    <div class="row">
        <div class="col-md-12">
            <h1 class="text-center" style="font-size: 23px;line-height: 1.35; font-weight: normal;margin-bottom: .5em;">
                {{ $article->title }}
                <br>
                <br>
            </h1>
        ...
        <div class="col-md-11 col-md-offset-1" style="font-size: 16px;  text-align:justify">
            <pre class="prettyprint" style="padding: 0px 30px !important;">
                      <code>
                        {!! $article->body !!}
                      </code>
                      </pre>
            ...
            <p class="tags">tags:
                ...
                <a href="{{ url('/tagged',$alltag->tag_id) }}" style="text-decoration: none"> <span
                        class="label label-warning"> {{ $alltag->tag_id }}</span></a>
                @endforeach
            </p>
            <br>
