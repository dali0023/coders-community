        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="name" class="form-control" readonly id="name" value="{{ Auth::user()->name }}">
              </div>
            </div>
            <div class="form-group">
              <label for="skill" class="col-sm-2 control-label">Skills:</label>
              <div class="col-sm-10">
                <select id="ques-interest" class="selectpicker form-control" data-show-subtext="true"
                  data-live-search="true" name="skill_select[]" multiple="multiple">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" value="{{ $edit_profile_value->education }}" class="form-control" id="education"
                  name="education" placeholder="Your education status">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="bio" value="{{ $edit_profile_value->bio }}" class="form-control" id="bio"
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select id="ques-interest" class="selectpicker form-control" data-show-subtext="true"
                  data-live-search="true" name="profession_category">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10 {{ $errors->has('education') ? ' has-error' : '' }}">
                <input type="text" value="{{ old('education') }}" class="form-control" id="education" name="education"
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10 {{ $errors->has('bio') ? ' has-error' : '' }}">
                <input type="text" name="bio" value="{{ old('bio') }}" class="form-control" id="bio"
                  placeholder="tell a little bit more..">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <ul class="nav nav-tabs navbar-left" role="tablist">
              ...
              <li role="presentation"><a href="#article" aria-controls="article" role="tab"
                  data-toggle="tab">Article</a></li>
              <li role="presentation" class="active"><a href="#question" aria-controls="job" role="tab"
                  data-toggle="tab">Question</a></li>
            </ul>
          </div>
              ...
              <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="question">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      <select id="ques-interest" class="selectpicker form-control" data-show-subtext="true"
                        data-live-search="true" name="category_interest[]" multiple="multiple">
                  ...
                  {!! Form::model($question_featured_update ,['url'
                  =>'/question-featured-update','files'=>true,'class'=>"form-horizontal"]) !!}
                  <div class="form-group">
                    <label for="ques-interest" class="col-md-4 control-label">Interested Category:</label>
                    <div class="col-md-8">
                      ...
                      <select class="selectpicker form-control" data-show-subtext="true" data-live-search="true"
                        name="category_interest[]" multiple="multiple">
                        @foreach($question_categories as $category)
                      ...
                      <a class="text-left" class="btn btn-primary" role="button" data-toggle="collapse"
                        href="#collapseExample" aria-expanded="false" aria-controls="collapseExample"
                        style="text-decoration: none;font-size: 14px;color:blue">
                ...
                <div role="tabpanel" class="tab-pane" id="article">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      <select id="ques-interest" class="selectpicker form-control" data-show-subtext="true"
                        data-live-search="true" name="article_interest[]" multiple="multiple">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-8">
                      ...
                      <a class="text-left" class="btn btn-primary" role="button" data-toggle="collapse"
                        href="#article_interest" aria-expanded="false" aria-controls="collapseExample"
                        style="text-decoration: none;font-size: 14px;color:blue">
                        Click Me! to Show Your Previous Interested Category
                      </a>
              ...
              <div class="col-md-9 col-sm-9 col-xs-9">
                <div class="question">
                  ...
                  <p><span class="date">
                    ...
                    <span class="time"> {{ date('h:i A',strtotime($articles->created_at)) }}</span> by<span
                      class="post-owner"><a href="#"> {{ App\User::find($articles->user_id)->name }} </a></span></p>
              ...
              <div class="col-md-9 col-sm-9 col-xs-9">
                <div class="question">
                  ...
                  <p>
                    ...
                    <span class="time"> {{ date('h:i A',strtotime($questions->created_at)) }}</span> by<span
                      class="post-owner"><a href="#">
        ...
        <div class="row">
          <div class="col-md-12 col-sm-6 col-xs-12 feature-articles">
            ...
            <ul class="text-left">
              ...
              <li><a href="{{url('groups/'.$community->group_id)}}">{{$i++}}. &nbsp
                  {{App\Group::find($community->group_id)->name}}</a></li>
