...
<div class="row">
  <div class="col-md-10 col-md-offset-1">
    ...
    <div class="box box-primary">
      ...
      @endif
      <br>
          <label for="exampleFormControlSelect2">Select Multiple Tags</label>
    ...
    'multiple' =>'multiple',
     'required' => 'required'
      ...
      @else
      <a class="text-left" class="btn btn-primary" role="button" data-toggle="collapse" href="#selected_tag"
        aria-expanded="false" aria-controls="collapseExample" style="text-decoration: none;font-size: 14px;color:blue">
